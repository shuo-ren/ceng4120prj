// LargeRouter.h - Optimized for large designs (design5)
#pragma once
#include <vector>
#include <string>
#include <queue>
...
public:
    LargeRouter(const NodeMap &n, const AdjacencyList &a, const NetList &nl,
    ...
    void route() {
        ...
        if(budget > 30.0) adaptiveRipupReroute(budget);
...
private:
    ...
    static constexpr int MAX_ITERATIONS = 2;       // Fewer iterations
